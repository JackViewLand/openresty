...
local function getGeneral()
    local general = {}
    general['http_status'] = ngx.var.status
    general['http_protocol'] = ngx.req.http_version()
    general['tls_version'] = ngx.var.ssl_protocol
    general['request_url'] = ngx.var.request_uri
    general['request_method'] = ngx.var.request_method
    general['request_port'] = ngx.var.server_port
    general['client_ip'] = ngx.var.remote_addr
